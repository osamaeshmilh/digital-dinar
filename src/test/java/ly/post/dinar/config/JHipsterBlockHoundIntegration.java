...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("ly.post.dinar.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("ly.post.dinar.security.DomainUserDetailsService", "createSpringSecurityUser");
