...
/**
 * Criteria class for the {@link ly.post.dinar.domain.City} entity. This class is used
 * in {@link ly.post.dinar.web.rest.CityResource} to receive all the possible filtering options from
