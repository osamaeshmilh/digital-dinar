      ...
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('digitalDinarApp.voucherCompany.createdBy')"
              for="voucher-company-createdBy"
            ></label>
            <input
              type="text"
              class="form-control"
              name="createdBy"
              id="voucher-company-createdBy"
              data-cy="createdBy"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('digitalDinarApp.voucherCompany.createdDate')"
              for="voucher-company-createdDate"
            ></label>
            <div class="d-flex">
              <input
                id="voucher-company-createdDate"
                data-cy="createdDate"
                type="datetime-local"
                class="form-control"
                name="createdDate"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('digitalDinarApp.voucherCompany.lastModifiedBy')"
              for="voucher-company-lastModifiedBy"
            ></label>
            <input
              type="text"
              class="form-control"
              name="lastModifiedBy"
              id="voucher-company-lastModifiedBy"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('digitalDinarApp.voucherCompany.lastModifiedDate')"
              for="voucher-company-lastModifiedDate"
            ></label>
            <div class="d-flex">
              <input
                id="voucher-company-lastModifiedDate"
