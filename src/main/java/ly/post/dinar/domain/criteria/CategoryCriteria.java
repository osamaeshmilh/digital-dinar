...
/**
 * Criteria class for the {@link ly.post.dinar.domain.Category} entity. This class is used
 * in {@link ly.post.dinar.web.rest.CategoryResource} to receive all the possible filtering options from
...
public class CategoryCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, nameAr, nameEn, code, createdBy, createdDate, lastModifiedBy, lastModifiedDate, distinct);
    }
