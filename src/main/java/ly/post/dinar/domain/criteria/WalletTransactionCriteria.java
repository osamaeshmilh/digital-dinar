...
public class WalletTransactionCriteria implements Serializable, Criteria {
    ...
    private WalletOwnerTypeFilter walletOwnerType;
    ...
    public WalletOwnerTypeFilter getWalletOwnerType() {
        return walletOwnerType;
    }

    public WalletOwnerTypeFilter walletOwnerType() {
        if (walletOwnerType == null) {
            walletOwnerType = new WalletOwnerTypeFilter();
        }
        return walletOwnerType;
    }

    public void setWalletOwnerType(WalletOwnerTypeFilter walletOwnerType) {
