    ...
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('digitalDinarApp.slider.createdBy')" for="slider-createdBy"></label>
            <input
              type="text"
              class="form-control"
              name="createdBy"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('digitalDinarApp.slider.createdDate')" for="slider-createdDate"></label>
            <div class="d-flex">
              <input
                id="slider-createdDate"
                data-cy="createdDate"
                type="datetime-local"
                class="form-control"
                name="createdDate"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('digitalDinarApp.slider.lastModifiedBy')" for="slider-lastModifiedBy"></label>
            <input
              type="text"
              class="form-control"
              name="lastModifiedBy"
              id="slider-lastModifiedBy"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('digitalDinarApp.slider.lastModifiedDate')" for="slider-lastModifiedDate"></label>
            <div class="d-flex">
              <input
                id="slider-lastModifiedDate"
