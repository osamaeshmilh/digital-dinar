...
describe('Service Tests', () => {
  describe('Voucher Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Voucher(123, 'AAAAAAA', 0, 'AAAAAAA', false, 0, 'AAAAAAA', currentDate, 'AAAAAAA', currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not update a Voucher', async () => {
      ...
      it('should partial update a Voucher', async () => {
      ...
      it('should not partial update a Voucher', async () => {
      ...
      it('should not return a list of Voucher', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Voucher', async () => {
