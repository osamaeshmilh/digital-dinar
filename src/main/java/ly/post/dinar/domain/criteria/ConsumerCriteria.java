...
/**
 * Criteria class for the {@link ly.post.dinar.domain.Consumer} entity. This class is used
 * in {@link ly.post.dinar.web.rest.ConsumerResource} to receive all the possible filtering options from
